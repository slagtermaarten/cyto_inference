...
# for (idx in c(12)) {
  ...
  purrr::pmap(function(description, perc, anchor_gs, i) {
    ...
    set.seed(42)
    N_folds = 10
    cv_object <- rsample::vfold_cv(p_dat, v = N_folds)
...
Supplemental: auantify separability based on time informative gene
sets
      ...
      if (F) {
        ...
        search_res <-
          ...
          tune_bayes(
            ...
            # How to measure performance?
            metrics = metric_set(roc_auc),
            control = control_bayes(no_improve = 3L, verbose = TRUE)
          )
